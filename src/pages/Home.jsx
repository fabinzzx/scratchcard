    ...
    <div className="relative min-h-[calc(100vh-80px)] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Begin your martial arts journey with Okinavan Shito Ryu Karate Academy. Win up to <strong className="text-white">50% OFF</strong> or <strong className="text-white">3 Months Free</strong> on your admission!
          </motion.p>
